...
const Carousel = React.forwardRef((
  ...
  React.useEffect(() => {
    ...
    api.on("reInit", reInitHandler)
    api.on("select", onSelect)

    return () => {
      api?.off("select", onSelect)
      api?.off("reInit", reInitHandler)
    };
  }, [api, onSelect])
...
const CarouselIndicators = React.forwardRef(({ className, ...props }, ref) => {
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive ? "w-6 bg-muted" : "w-2 bg-muted"
            )}
